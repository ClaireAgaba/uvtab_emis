...
urlpatterns = [
    ...
    # Practical Assessor Management URLs
    path('practical-assessors/', views.practical_assessor_list, name='practical_assessor_list'),
    path('practical-assessors/create/', views.create_practical_assessor, name='create_practical_assessor'),
    path('practical-assessors/<int:pk>/', views.practical_assessor_view, name='practical_assessor_view'),
    path('practical-assessors/<int:pk>/edit/', views.edit_practical_assessor, name='edit_practical_assessor'),
    path('practical-assessors/<int:pk>/delete/', views.delete_practical_assessor, name='delete_practical_assessor'),
    path('practical-assessors/<int:pk>/toggle-status/', views.toggle_practical_assessor_status, name='toggle_practical_assessor_status'),
    path('practical-assessors/<int:pk>/assign/', views.assign_practical_assessor, name='assign_practical_assessor'),
    path('practical-assessors/<int:pk>/remove-assignment/<int:assignment_id>/', views.remove_practical_assessor_assignment, name='remove_practical_assessor_assignment'),
    path('practical-assessors/marksheet/<int:assignment_id>/', views.practical_marksheet_view, name='practical_marksheet_view'),
    path('api/villages/', views.api_villages, name='api_villages'),
    ...
    path('api/modules-by-occupation/', views.api_modules_for_occupation, name='api_modules_by_occupation'),
    path('api/modules-for-occupation/', views.api_modules_for_occupation, name='api_modules_for_occupation'),
    path('api/assignment-candidates/', views.api_assignment_candidates, name='api_assignment_candidates'),
    path('save-practical-marks/', views.save_practical_marks, name='save_practical_marks'),
    path('complaints/bulk-assign/', views.complaints_bulk_assign, name='complaints_bulk_assign'),
    path('complaints/bulk-archive/', views.complaints_bulk_archive, name='complaints_bulk_archive'),
    path('complaints/bulk-unarchive/', views.complaints_bulk_unarchive, name='complaints_bulk_unarchive'),
    path('complaints/bulk-delete/', views.complaints_bulk_delete, name='complaints_bulk_delete'),
    path('complaints/bulk-action/', views.complaints_bulk_action, name='complaints_bulk_action'),
    ...
    path('api/center-branches/', views.api_center_branches, name='api_center_branches'),
    ...
    path('practical-assessment/approve/<int:marksheet_id>/', views.approve_practical_marksheet, name='approve_practical_marksheet'),
 ]
