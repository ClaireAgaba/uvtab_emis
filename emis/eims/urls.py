...
urlpatterns = [
    ...
    path('occupations/export/', views.occupations_export, name='occupations_export'),
    ...
    path('candidates/<int:id>/change-assessment-series/', views.change_assessment_series, name='change_assessment_series'),
